...
@app.route('/logout')
def logout():
    flash(session['usuario_logado'] + ' deslogado')
...
def autenticar():
    ...
    if usuario:
        ...
        flash(request.form['usuario'] + ' não logado!')
...
def editar(id):
    ...
    return render_template('editar.html', titulo='Editando Jogo', jogo=jogo, capa_jogo=nome_image)
